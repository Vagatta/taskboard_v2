  ...
  return (
    <Card className="border border-slate-800 bg-slate-900/60">
      <div className="flex flex-col gap-4">
        ...
        <Tabs aria-label="Gestión de workspaces" variant="underline" className="w-full">
          <TabItem title="Workspaces" active>
          ...
          <TabItem title="Invitar miembros" disabled={!selectedWorkspaceId}>
            <div className="mt-4 space-y-3">
              {selectedWorkspaceId ? (
                <>
