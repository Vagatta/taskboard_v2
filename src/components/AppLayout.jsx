...
export default function AppLayout({
  ...
  const backgroundClass =
    theme === 'light'
      ...
      : 'from-slate-950 via-sky-900 to-indigo-900';
  ...
  const contentCardClass =
    theme === 'light'
      ...
      : 'border-white/10 bg-slate-950/50 shadow-black/40';
  ...
  return (
    <div className={`h-screen bg-gradient-to-br ${backgroundClass} text-slate-100`}>
      <div className="flex h-full flex-col gap-6 px-4 py-4 lg:flex-row lg:py-8">
        <aside className="hidden w-64 shrink-0 lg:flex">
          <div className="flex h-full w-full flex-col rounded-3xl border border-white/10 bg-slate-950/40 p-6 shadow-2xl shadow-black/40 backdrop-blur-xl">
            <div>
        ...
        <main className="no-scrollbar flex-1 overflow-y-auto px-4 lg:px-10 lg:max-w-7xl lg:mx-auto">
          {navigationItems.length > 0 ? (
            <div className="mb-4 rounded-3xl border border-white/10 bg-slate-950/40 p-4 shadow-lg shadow-black/30 backdrop-blur-xl lg:hidden">
